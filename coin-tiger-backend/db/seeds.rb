...
favorite1 = Favorite.create(apiId: "bitcoin", name: "Bitcoin", symbol:"btc", user: user1)
favorite2 = Favorite.create(apiId: "ethereum", name: "Ethereum", symbol:"eth", user: user1)
